              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Accessibility:</strong> Making information available to everyone
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-2 mt-1 h-5 w-5 rounded-full bg-[#01a8bd] flex items-center justify-center text-white">
                    ...
                    <span>
                      <strong>Innovation:</strong> Continuously improving our AI solutions
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-2 mt-1 h-5 w-5 rounded-full bg-[#01a8bd] flex items-center justify-center text-white">
                    ...
                    <span>
                      <strong>Accuracy:</strong> Providing reliable and precise information
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-2 mt-1 h-5 w-5 rounded-full bg-[#01a8bd] flex items-center justify-center text-white">
                    ...
                    <span>
                      <strong>Inclusivity:</strong> Supporting multiple languages and diverse needs
                    </span>
                  </li>
                </ul>
              </div>
